...
public class MyCustomScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(this.textRenderer, Text.literal("指令自定義面板"), this.width / 2, 20, 0xFFAA00);
        context.drawTextWithShadow(this.textRenderer, Text.literal("請輸入指令 (不需 /):"), this.width / 2 - 100, 45, 0xFFFFFF);
    }
